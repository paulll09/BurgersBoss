            ...
            >
                ...
                <div className="flex gap-3 px-6 pt-4 pb-6">
                    ...
                    <button
                        ...
                        className="cursor-pointer flex-1 py-3 rounded-xl bg-primary hover:bg-primary-dark text-white font-bold text-sm uppercase tracking-wider transition-all active:scale-[0.97] shadow-[0_4px_14px_rgba(45,106,45,0.28)]"
                    >
                        {confirmText}
                    </button>
                </div>
