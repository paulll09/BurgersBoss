            ...
            <div className="flex items-center justify-between mb-6 gap-3">
                <div>
                    ...
                    <p className="font-body text-xs mt-0.5" style={{ color: 'rgba(0,0,0,0.40)' }}>
                        Configurá los días y horarios de apertura
                    </p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving || !form}
                    className="cursor-pointer flex items-center gap-2 bg-primary hover:bg-primary-dark text-white px-4 py-2.5 rounded-xl font-bold text-sm uppercase tracking-widest transition-all active:scale-95 shadow-[0_4px_14px_rgba(45,106,45,0.28)] disabled:opacity-60 shrink-0"
                >
