        ...
        <div className="max-w-6xl mx-auto animate-fade-up pb-10">
            ...
            <div className="flex items-center justify-between mb-6 gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="font-display text-2xl sm:text-3xl font-black text-secondary uppercase tracking-wider leading-none">Promociones</h1>
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`cursor-pointer px-3.5 py-2 rounded-xl text-sm font-bold uppercase tracking-wider transition-all active:scale-95 ${
                                                    selected
                                                        ? 'bg-primary text-white shadow-[0_2px_8px_rgba(217,0,9,0.25)]'
