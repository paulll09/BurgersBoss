...
export default function HomePage() {
    ...
    const STAT_THEMES = [
        ...
        {
            bg: '#F59E0B',
            labelColor: 'rgba(10,10,10,0.52)',
            valueColor: '#0a0a0a',
            subColor: 'rgba(10,10,10,0.60)',
            iconBg: 'rgba(0,0,0,0.10)',
            iconColor: '#1a4a1a',
        },
        {
            bg: '#0a0a0a',
            labelColor: 'rgba(245,158,11,0.70)',
            valueColor: '#F59E0B',
    ...
    return (
        <>
            ...
            >
                ...
                {/* ── BLOQUES STATS — 3 franjas de color sólido ───── */}
                    ...
                    {STATS.map(({ icon, label, value, sub, href }, i) => {
                        ...
                        return (
                            <Tag
                                ...
                                className="flex items-center gap-5 px-6 py-8"
                                style={{
                                    background: t.bg,
                                    textDecoration: 'none',
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p
                                        ...
                                        style={{ fontSize: '0.58rem', letterSpacing: '0.32em', color: t.labelColor, marginBottom: '4px' }}
                                    >
                                        {label}
                                    </p>
                                    <p
                                        className="font-display uppercase leading-none"
                                        style={{ fontSize: 'clamp(1.5rem, 7vw, 2.2rem)', color: t.valueColor }}
                                    >
                                        {value}
                                    </p>
                                    <p className="text-sm" style={{ color: t.subColor, marginTop: '4px' }}>
                                        {sub}
                                    </p>
                                </div>
